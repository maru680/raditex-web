        ...
        <section className="mx-auto grid max-w-7xl gap-14 px-6 pb-20 pt-16 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:pb-28 lg:pt-24">
          <div className="max-w-2xl">
            ...
            <div className="mt-5 inline-flex rounded-full border border-cyan-400/20 bg-cyan-400/10 px-4 py-2 text-sm text-cyan-200">
              Kiire põhjalik ülevaade · selge tuevikuplaan · mõõdetavad tulemused
            </div>
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 md:p-10">
            ...
            <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
              {[
                ...
                ["Juhtimine ja otsustammine", "Otsuseid tehakse kõhutunde ja tunnetuse, mitte reaalajas kättesaadavate andmete põhjal. Suureneb risk teha valesid investeeringuid ja magada maha kriitilised kohad efektiivsuse tõstmiseks."],
                ["IT-süsteemid ja -tugi", "IT-partner keskendub vaid jooksvate tulekahjude kustutamisele, puudub pikk plaan ja ennetav arendus.Uute lahenduste juurutamine venib kuude viisi või ebaõnnestub täielikult, sest puudub tehnoloogiline visioon."],
            ...
            {[
              ...
              },
              {
                ...
                items: [
                  ...
                  "Süsteemide ja andmevoogude kaardistus ning prtotsessi kirjeldused",
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              ...
              <div className="mt-6 space-y-3 text-sm leading-7 text-slate-300">
                ...
                <p>• soovitud tulemuse ja ressurss teostuseks</p>
              </div>
...
export default function Page() {
  ...
  const stats = useMemo(
    () => [
      ...
      { value: "120+", label: "läbiviidud analüüsi" },
      { value: "4.8 m€", label: "digi investeeringuid" },
    ],
    []
  );
